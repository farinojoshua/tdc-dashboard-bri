...
class MonthlyTargetController extends Controller
{
    ...
    public function index()
    {
                ...
                ->addColumn('action', function ($monthlyTarget) {
                    return '
                        ...
                        <a class="block w-full px-2 py-1 mb-1 text-xs text-center text-white transition duration-500 bg-gray-700 border border-gray-700 rounded-md select-none btn-edit ease hover:bg-gray-800 focus:outline-none focus:shadow-outline"
                            href="' . route('admin.user-management.monthly-target.edit', $monthlyTarget -> id) . '">
                        ...
                        <form class="block w-full" action="' . route('admin.user-management.monthly-target.destroy', $monthlyTarget->id) . '" method="POST">
        ...
        return view('admin.user-management.monthly-target.index');
    ...
    {
        return view('admin.user-management.monthly-target.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.user-management.monthly-target.index')->with('success', 'Monthly target created successfully.');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.user-management.monthly-target.edit', compact('monthlyTarget'));
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.user-management.monthly-target.index')->with('success', 'Monthly target updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.user-management.monthly-target.index')->with('success', 'Monthly target deleted successfully.');
    }
}
